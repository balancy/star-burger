...
Docker, docker-compose и git должны быть уже установлены.
...
Cоздайте файл `.env.prod` в каталоге проекта со следующими настройками:
...
Cоздайте файл `.env.db.prod` в каталоге проекта и скопируйте сюда следующие переменные окружения из файла `.env.prod`:
